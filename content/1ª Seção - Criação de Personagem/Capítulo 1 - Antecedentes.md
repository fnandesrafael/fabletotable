...
Essa ambientação, se assim podemos chamá-la, é um dos primeiros fundamentos que podemos usar para nortear a construção dessa figura tão importante que é o seu personagem. É a partir desse ponto que começamos a compreender não apenas **de onde ele veio**, mas também **quem ele é** dentro do mundo. Ao longo deste capítulo, desenvolveremos justamente esses elementos fundamentais: identidade, aparência, passado, ofício, relações, motivações e conflitos. Explorando como cada um deles contribui para deixar seu personagem mais vivo, complexo e inserido dentro da história. É desse ponto inicial que poderemos partir para todos os outros.

Para isso, utilize as descrições de cada [[Antecedentes|Antecedente]] para compreender sua importância e responda a cada uma das perguntas listadas abaixo. A ideia é que você de fato escreva uma biografia — em texto corrido mesmo — como se estivesse contando a história do seu personagem, usando cada pergunta como guia para descrevê-lo. Você pode fazer isso num pequeno bloco de papel, ou em algum documento digital, ou até mesmo aproveitar a plataforma online da [[Ficha de Personagem]] que conta com um recurso próprio para responder essas perguntas e, assim, criar esse resumo biográfico de forma automática!
...
Todo nome carrega um significado. Seu persnagem possui um nome de batismo. Um nome pelo qual seus pais ou aqueles que o criaram lhe chamam. Esse nome já carrega consigo uma série de significados que, por vezes, conferem ao personagem as peculiaridades associadas ao seu sentido.
...
Pense neste antecedente como uma pequena linha do tempo pessoal. Cada evento representa um momento decisivo que ajuda a explicar quem seu personagem se tornou e por que ele está onde está no início da história.

> [!example] Exemplo
> 
> **Matthias Rourke** nasceu em uma pequena cidade portuária constantemente envolta em neblina. Filho de um barqueiro e de uma costureira, passou a infância ajudando a família nas docas e ouvindo histórias de viajantes que chegavam de terras distantes. Durante a juventude, sua vida mudou quando um estranho acidente em um armazém provocou um incêndio que destruiu parte do cais e levou consigo a vida de seu pai.
> 
> Após esse evento, Matthias passou anos trabalhando em diferentes portos e cidades costeiras, tentando reconstruir sua vida enquanto buscava entender as circunstâncias estranhas que cercaram o incêndio. Esse período o transformou em um homem reservado e desconfiado, acostumado a observar antes de agir.
> 
...
Ao final deste capítulo, seu personagem agora deixa de ser apenas um conjunto de ideias soltas e passa a existir como alguém inserido no mundo — com [[#Identidade]], [[#Aparência]], [[#Histórico]], [[#Ofícios|Ofício]], [[#Economia]], [[#Motivações]] e [[#Aflições]] que o tornam único. Esses elementos formam a base narrativa sobre a qual todas as suas decisões serão construídas ao longo da [[Campanha]]. No entanto, essa é apenas parte do caminho. No próximo capítulo, avançaremos para além da história e conheceremos os [[Capítulo 2 - Atributos e Perícias|Atributos e Perícias]].
