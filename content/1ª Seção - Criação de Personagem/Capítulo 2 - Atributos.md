...
Este capítulo foi feito para que você compreenda o que são os atributos e as perícias e aprenda como elas funcionam mecanicamente. No capítulo seguinte, [[Capítulo 4 - Arquétipos]], você terá uma ideia mais clara de como escolher e valorizar cada uma dessas características, permitindo criar seu personagem ideal.
...
Os [[Pontos de Atributo]] adquiridos ao longo da progressão, são de livre distribuição do jogador. O [[Bônus de Proficiência]] deve seguir as diretrizes de cada [[Capítulo 4 - Arquétipos#Personalidades|Personaidade]] e [[Capítulo 4 - Arquétipos#Posturas|Postura]] descritas no [[Capítulo 4 - Arquétipos]].
