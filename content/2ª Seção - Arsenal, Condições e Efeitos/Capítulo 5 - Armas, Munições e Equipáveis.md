...
| Arco              | Flecha                 | 1                 | Precisão     | Perfurante   | 1d10      | —              | Coldre             | 1         | 40         |
| Arco Longo        | Flecha                 | 1                 | Precisão     | Perfurante   | 3d6       | —              | Coldre             | 2         | 65         |
| Balestra          | Dardo                  | 3                 | Precisão     | Perfurante   | 3d4       | —              | Coldre             | 3         | 90         |
...
| Arma                 | Tipo de Munição | Capacidade | Perícia Base | Tipo de Dano | Dano Base                                | **Outros Efeitos** | Armazenamento | Peso (kg) | Preço (V$) |
| -------------------- | --------------- | ---------- | ------------ | ------------ | ---------------------------------------- | ------------------ | ------------- | --------- | ---------- |
| Azagaia              | —               | —          | Precisão     | Perfurante   | 1d8 + Fortitude                          | —                  | Coldre        | 2         | 14         |
| Bomba Adesiva        | —               | —          | Manipulação  | Contundente  | 2d10                                     | —                  | Bolsa         | 2         | 80         |
| Bomba de Fumaça      | —               | —          | Precisão     | —            | —                                        | Cegueira 1         | Bolsa         | 1         | 25         |
| Bomba de Luz         | —               | —          | Precisão     | —            | —                                        | Atordoamento       | Bolsa         | 1         | 30         |
| Coquetel Incendiário | —               | —          | Precisão     | Abrasador    | 2d6                                      | Queimadura         | Bolsa         | 1,5       | 20         |
| Faca de Arremesso    | —               | —          | Precisão     | Cortante     | 1d6 + Bônus de Proficiência de Fortitude | —                  | Bolsa         | 1         | 12         |
| Granada de Impacto   | —               | —          | Precisão     | Contundente  | 2d8                                      | —                  | Bolsa         | 2         | 50         |
| Granada Fragmentada  | —               | —          | Precisão     | Cortante     | 3d6                                      | —                  | Bolsa         | 2         | 60         |
| Granada Incendiária  | —               | —          | Precisão     | Abrasador    | 2d8                                      | Queimadura         | Bolsa         | 2         | 55         |
...
| Arma                      | Tipo de Munição | Capacidade | Perícia Base | Tipo de Dano | Dano Base | Outros Efeitos | Armazenamento | Peso (kg) | Preço (V$) |
| ------------------------- | --------------- | ---------- | ------------ | ------------ | --------- | -------------- | ------------- | --------- | ---------- |
| Botão de Punho Explosivo  | —               | —          | Arremesso    | Contundente  | 1d4       | —              | Bolsa         | 0.02      | 15         |
| Anel com Lâmina Oculta    | —               | —          | Manipulação  | Perfurante   | 1d4       | —              | Acoplado      | 0.01      | 30         |
| Bengala com Lâmina Oculta | —               | —          | Precisão     | Cortante     | 1d6       | —              | Acoplado      | 1         | 45         |
| Bracelete com Ejetor      | Dardo           | 1          | Precisão     | Perfuração   | 1d6       | —              | Acoplado      | 0.5       | 45         |
| Piteira-Zarabatana        | Dardo           | 1          | Precisão     | Perfuração   | 1d4       | —              | Acoplado      | 0.02      | 20         |
| Cinto com Fivela Lâminada | —               | —          | Mobilidade   | Cortante     | 1d6       | —              | Acoplado      | 0.5       | 30         |
| Caneta de Pena Afiada     | —               | —          | Precisão     | Perfuração   | 1d4       | —              | Acoplado      | 0.01      | 15         |
| Guarda-Chuva Perfurante   | —               | —          | Mobilidade   | Cortante     | 1d8       | —              | Acoplado      | 1         | 30         |
| Lâmina de Manga  Retrátil | —               | —          | Manipulação  | Cortante     | 1d6       | —              | Acoplado      | 0.5       | 45         |
| Soqueira Embutida em Luva | —               | —          | Fortitude    | Contudente   | 1d8       | —              | Acoplado      | 0.25      | 28         |
| Perfume Venenoso          | —               | —          | Manipulação  | —            | Especial  | Paralizia      | Disfarçado    | 0.3       | 170        |
| Pistola de Palma          | Leve            | 1          | Pontaria     | Perfurante   | 1d4       | —              | Acoplado      | 0.6       | 42         |
